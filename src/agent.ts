...
║  ─────────────────────────────────────────────────────────────────────────── ║
║  • proveOutside     - Prove you're outdoors right now (0.003 ETH)           ║
║  • handwrittenDate  - Handwritten note with date + POIDH (0.002 ETH)        ║
║  • mealPhoto        - Photo of your current meal (0.002 ETH)                ║
║                                                                              ║
║  AI-JUDGED BOUNTIES (GPT-4 Vision picks best after deadline):               ║
║  ─────────────────────────────────────────────────────────────────────────── ║
║  • objectTower      - Creative object stacking contest (0.005 ETH)          ║
║  • shadowArt        - Creative shadow photography (0.004 ETH)               ║
║  • animalPhoto      - Best pet/wildlife photo (0.003 ETH)                   ║
║                                                                              ║
